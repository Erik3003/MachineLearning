#!/usr/bin/python3
# Environement entsprechend Sutton: 4*4 Gridworld
#
...
class Environment:
    ...
    def __init__(self):
        ...
        self.gw_x_count = 4
        self.gw_y_count = 4
        self.destinationPos = [0, 0]         # abweichend zu Sutton nur ein terminaler state
        ...
        self.start_state = self.coord2state(self.gw_y_count-1,2)
    ...
    def step(self, action):
        ...
        # gegen ein Hindernis gelaufen oder aus der Gridworld
